...
namespace GameEngine.Engine.PhysicsEngine
{
    ...
    public sealed class Body : Component
    {
            ...
            :base(gameObject)
        {
            ...
            _lastPosition = new Vector2(_transform.Position.X, _transform.Position.Y);
        ...
        internal void Step(float time, Vector2 gravity, int iterations)
        {
            ...
            if (!IsKinematic)
            {
                ...
                _transform.Position += _linearVelocity * time + 0.5f * _acceleration * time * time;

                _transform.Angle += _rotationalVelocity * time;
        ...
        public static Body CreateCircleBody(GameObject gameObject, Transform transform,float radius, float mass = 1f, float density = 1f, float restitution = 0.5f, bool isKinematic = false, bool isStatic = false, bool isTrigger = false)
        {
        ...
        public static Body CreateBoxBody(GameObject gameObject, Transform transform, Vector2 size, float mass = 1f, float density = 1f, float restitution = 0.5f, bool isKinematic = false, bool isStatic = false, bool isTrigger = false)
        {
