...
namespace GameEngine.Engine.PhysicsEngine
{
    public sealed class World
    {
        ...
        public const float MAX_BODY_SIZE = 250f * 250f;
        ...
        public bool Collide(Body bodyA, Body bodyB)
        {
            ...
            switch (typeCollisionA)
            {
                case TypeCollision.Box:
                    ...
                    {
                        case TypeCollision.Box:
                            return CollisionUtilites.BoxCollider(bodyA.Transform.Position, bodyA.Size,
                                bodyB.Transform.Position, bodyB.Size);
                            
                        case TypeCollision.Circle:
                        {
                            return CollisionUtilites.IsBoxWithCircleColliding(bodyA.Transform.Position, bodyA.Size,
                ...
                case TypeCollision.Circle:
                    ...
                    {
                        case TypeCollision.Circle:
                            return CollisionUtilites.CircleCollider(bodyA.Transform.Position, bodyA.Radius, bodyB.Transform.Position,
                                bodyB.Radius);
                        case TypeCollision.Box:
                            return CollisionUtilites.IsBoxWithCircleColliding(bodyB.Transform.Position, bodyB.Size,
