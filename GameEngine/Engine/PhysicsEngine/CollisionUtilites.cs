...
namespace GameEngine.Engine.PhysicsEngine
{
    ...
    public static class CollisionUtilites
    {
        ...
        {
            var distance = Math.Sqrt((position1.X * position2.X) + (position1.Y * position2.Y));
            ...
            float circleRadius)
        {
            ...
            var distance = Math.Sqrt(vectorDistance.X * vectorDistance.X + vectorDistance.Y * vectorDistance.Y);
